<template>
  <div class="main">
    <div class="header clearfix">
      <div class="title">高考管理</div>
      <el-button @click="getdetail" type="primary" size="small" plain>查看高考信息</el-button>
    </div>
    <el-form
      :model="ruleForm"
      :rules="rules"
    ...
    >
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="高考标题" prop="title">
            <el-input placeholder="请输入高考标题" v-model="ruleForm.title"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="高考类型" prop="type">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="高考封面" prop="cover">
            <el-upload
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        detail: [{ required: true, message: "请输入高考", trigger: "change" }],
  ...
  methods: {
    ...
    async savedetail() {
      let that = this;
      await myAxios.newexamination(this.ruleForm).then(res => {
        let data = res.data;
