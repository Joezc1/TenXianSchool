<template>
  <div class="main">
    <div class="header clearfix">
      <div class="title">概况管理</div>
      <el-button @click="getdetail" type="primary" size="small" plain>查看概况信息</el-button>
    </div>
    <el-form
      :model="ruleForm"
      :rules="rules"
    ...
    >
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="概况标题" prop="title">
            <el-input placeholder="请输入概况标题" v-model="ruleForm.title"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="概况类型" prop="type">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="概况封面" prop="cover">
            <el-upload
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="公告详情" prop="survey">
            <vue-editor
              id="editor"
              useCustomImageHandler
              @image-added="handleImageAdded"
              v-model="ruleForm.survey"
            ></vue-editor>
          </el-form-item>
        </el-col>
      </el-row>
...
import * as myAxios from "../../api/surveymanage";
export default {
  name: "home",
  data() {
    return {
      ...
      rules: {
        ...
        survey: [{ required: true, message: "请输入概况", trigger: "change" }],
  ...
  methods: {
    ...
    async saveSurvey() {
      let that = this;
      await myAxios.newsurvey(this.ruleForm).then(res => {
        let data = res.data;
