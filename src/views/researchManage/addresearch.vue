<template>
  <div class="main">
    <div class="header clearfix">
      <div class="title">调研管理</div>
      <el-button @click="getdetail" type="primary" size="small" plain>查看调研信息</el-button>
    </div>
    <el-form
      :model="ruleForm"
      :rules="rules"
    ...
    >
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="调研标题" prop="title">
            <el-input placeholder="请输入调研标题" v-model="ruleForm.title"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="调研类型" prop="type">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="调研封面" prop="cover">
            <el-upload
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        detail: [{ required: true, message: "请输入调研", trigger: "change" }],
  ...
  methods: {
    ...
    async savedetail() {
      let that = this;
      await myAxios.newresearch(this.ruleForm).then(res => {
        let data = res.data;
