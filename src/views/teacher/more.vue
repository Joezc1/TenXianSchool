...
export default {
  ...
  methods: {
    getList() {
      ...
      myAxios.typeteacher(this.$route.query.type, this.reqData).then(res => {
        let data = res.data;
    ...
    handleSearch(v) {
      ...
      let that = this;
      myAxios.typeteacher('null', this.reqData).then(res => {
        let data = res.data;
        that.morelist = data.list;
        that.total = parseInt(data.pageCount);
      });
    ...
    handleTop(v) {
      let that = this;
      myAxios.typeteacher(v, this.reqData).then(res => {
        let data = res.data;
        that.morelist = data.list;
        that.total = parseInt(data.pageCount);
      });
