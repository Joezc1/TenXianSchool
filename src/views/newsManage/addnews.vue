<template>
  <div class="main">
    <div class="header clearfix">
      ...
      <el-button @click="getdetail" type="primary" size="small" plain>查看新闻信息</el-button>
    </div>
    <el-form
      :model="ruleForm"
      :rules="rules"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        detail: [{ required: true, message: "请输入新闻", trigger: "change" }],
  ...
  methods: {
    ...
    async savedetail() {
      let that = this;
      await myAxios.newnews(this.ruleForm).then(res => {
        let data = res.data;
