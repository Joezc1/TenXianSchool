...
<template>
  <div class="partybuild-main clearfix">
    ...
    <div class="main-right">
        <sectionRight :morelist="morelist"
...
export default {
  ...
  methods: {
     getList() {
      ...
      myAxios.typecyl(this.$route.query.type, this.reqData).then(res => {
        let data = res.data;
    ...
    handleSearch(v) {
      ...
      let that = this;
      myAxios.typecyl('null', this.reqData).then(res => {
        let data = res.data;
        that.morelist = data.list;
        that.total = parseInt(data.pageCount);
      });
    ...
    handleTop(v) {
      let that = this;
      myAxios.typecyl(v, this.reqData).then(res => {
        let data = res.data;
        that.morelist = data.list;
        that.total = parseInt(data.pageCount);
      });
