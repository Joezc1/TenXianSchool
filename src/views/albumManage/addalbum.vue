<template>
  <div class="main">
    <div class="header clearfix">
      ...
      <el-button type="primary" size="small" @click="getdetail" plain>查看相册信息</el-button>
    </div>
    <el-form
      :model="ruleForm"
      :rules="rules"
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="相册标题" prop="title">
            <el-input placeholder="请输入相册标题" v-model="ruleForm.title"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        detail: [{ required: true, message: "请输入相册", trigger: "change" }],
  ...
  methods: {
    ...
    async savedetail() {
      let that = this;
      await myAxios.newalbum(this.ruleForm).then(res => {
        let data = res.data;
